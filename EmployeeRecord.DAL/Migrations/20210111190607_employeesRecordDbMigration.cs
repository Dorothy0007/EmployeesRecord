...
{
    public partial class employeesRecordDbMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeStay", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeStay_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeStay_EmployeeId",
                table: "EmployeeStay",
                column: "EmployeeId");
        }
